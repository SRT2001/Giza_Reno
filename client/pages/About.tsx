        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div className="text-center">
              <div className="mb-4 overflow-hidden rounded-lg">
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2Ff8fc8faad3844710a06fef1ff8cf1884%2Ffd89736fcd404d16b0b5aed80f852f66?format=webp&width=1600&height=2400"
                  alt="Jane Smith"
                  className="w-full h-auto object-cover"
                />
              </div>
            ...
            <div className="text-center">
              <div className="mb-4 overflow-hidden rounded-lg">
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2Ff8fc8faad3844710a06fef1ff8cf1884%2F2328ee7c417945f6967c6974b9bc3d3e?format=webp&width=1600&height=2400"
                  alt="Michael Johnson"
                  className="w-full h-auto object-cover"
                />
              </div>
